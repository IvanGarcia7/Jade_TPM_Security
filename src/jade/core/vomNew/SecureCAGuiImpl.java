...
import jade.core.vomNew.SecureCAGui;
...
private CAPlatform myAgent;
	...
	private JTextField INDEX, USER, PASS;
    ...
    rootPanel.setMinimumSize(new Dimension(560, 100));
    rootPanel.setPreferredSize(new Dimension(560, 100));
    ...
    USER = new JTextField(64);
    USER.setMinimumSize(new Dimension(222, 20));
    USER.setPreferredSize(new Dimension(222, 20));
    gridBagConstraints = new GridBagConstraints();
    gridBagConstraints.gridx = 1;
    gridBagConstraints.gridy = 1;
    gridBagConstraints.gridwidth = 3;
    gridBagConstraints.anchor = GridBagConstraints.NORTHWEST;
    gridBagConstraints.insets = new Insets(5, 3, 0, 3);
    rootPanel.add(USER, gridBagConstraints);
    ...
    PASS = new JTextField(64);
    PASS.setMinimumSize(new Dimension(222, 20));
    PASS.setPreferredSize(new Dimension(222, 20));
    gridBagConstraints = new GridBagConstraints();
    ...
    gridBagConstraints.anchor = GridBagConstraints.NORTHWEST;
    gridBagConstraints.insets = new Insets(5, 3, 0, 3);
    rootPanel.add(PASS, gridBagConstraints);
    	...
    	INIT.addActionListener(new ActionListener(){
	  	public void actionPerformed(ActionEvent e) {
	  		...
	  		try {
				...
				myAgent.doInitializeCA(pubKeyPriv,pubKey,USER.getText(),PASS.getText());
				//doListCA();
			} catch (Exception e1) {
