...
public class SecureAgentIntraService<Triplet> extends BaseService {
    ...
    private ServiceHelper myServiceHelper = new SecureAgentIntraHelper();
    ...
    public Class getHorizontalInterface() {
        return SecureAgentIntraSlice.class;
    }
    ...
    public ServiceHelper getHelper(Agent agente) throws ServiceException {
        if (agente instanceof SecureAgent){
            return myServiceHelper;
        }else{
            throw new ServiceException("Este servicio no es adecuado para el agente seleccionado actualmente");
        }
    }
    ...
    public class SecureAgentIntraHelper implements jade.core.SecureTPM.INTRA.SecureAgentIntraHelper{
        ...
        */
        ...
        public  void doSecureMove(SecureAgent agente, Location destino) {
            ...
            */
            ...
            if (lista_peticiones_movimiento.size()!=0 || lista_peticiones_clonacion.size()!=0) {
                manejador_sincronizado(agente,destino);
            }
            else {
        ...
        public synchronized void manejador_sincronizado(SecureAgent agente, Location destino){
        ...
        public void doSecureClone(SecureAgent agente, Location destino, String nombre_agente) {
            ...
            if (lista_peticiones_movimiento.size()>0 || lista_peticiones_clonacion.size()>0) {
                manejador_copiado(agente,destino,nombre_agente);
            }
            else {
        ...
        public synchronized void manejador_copiado(SecureAgent agente, Location destino, String nombre_agente){
    ...
    private class CommandTargetSink implements Sink {
        ...
        private void ManejadorPeticionAtestacion(VerticalCommand comando) throws ServiceException {
            ...
            try {
                ...
                ie.printStackTrace();
                objetivo_confirmacion = (SecureAgentIntraSlice) getFreshSlice(paquete_confirmacion.getLocationorigen().getName());
                objetivo_confirmacion.doRequestConfirmation(comando_generado);
            }
        }
    }
    ...
    private class CommandSourceSink implements Sink {
        ...
        private void manejador_peticion_atestacion(VerticalCommand comando) throws ServiceException {
            ...
            SecureAgentIntraSlice objetivo = (SecureAgentIntraSlice) getSlice(paquete.getLocationdestino().getName());
            try {
    ...
    private class ServiceComponent implements Service.Slice{
        ...
        public Service getService() {
            return SecureAgentIntraService.this;
        }

        @Override
        public Node getNode() throws ServiceException, IMTPException {
            return SecureAgentIntraService.this.getLocalNode();
        }
        ...
        public VerticalCommand serve(HorizontalCommand comando){
            ...
            try{
                ...
                if(comando.getName().equals(SecureAgentIntraSlice.REMOTE_REQUEST_ATTESTATION)){
                ...
                }else if(comando.getName().equals(SecureAgentIntraSlice.REMOTE_REQUEST_CONFIRMATION)){
