...
public class Pruebas_tpm2_informacion_verificada {
    ...
    public void testAdd() {
        ...
        try {
            ...
            Agencia.tpm2_firmar_informacion(ruta_handler, ruta_archivo_plano, ruta_archivo_firmado);

            int resultado = Agencia.tpm2_informacion_verificada(ruta_archivo_plano, ruta_handler, ruta_archivo_firmado);
