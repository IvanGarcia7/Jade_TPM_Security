  ...
  private MobileAgentDescription createMAD(byte[] instance, byte[] jar, AID name) {
    ...
    mad.setData(new String(Base64.encodeBase64(_instance)));
      ...
      try{
          ...
          System.out.println("I NEET TO SEND THE AGENT WITH THE FOLLOWING INFORMATION:");
          System.out.println("PUBLICK KEY "+destinyPub);
          ...
          Pair<String,byte []> ObjectSender = new Pair<String, byte []>(token,_jar);
