 ...
 * 
 */
public interface MigrationVocabulary extends JADEManagementVocabulary {

  public static final String MOBILE_AGENT_DESCRIPTION =
    "mobile-agent-description";
  public static final String MOBILE_AGENT_DESCRIPTION_NAME = "name";
  public static final String MOBILE_AGENT_DESCRIPTION_DESTINATION =
    "destination";
  public static final String MOBILE_AGENT_DESCRIPTION_AGENT_PROFILE =
    "agent-profile";
  public static final String MOBILE_AGENT_DESCRIPTION_AGENT_VERSION =
    "agent-version";
  public static final String MOBILE_AGENT_DESCRIPTION_SIGNATURE = "signature";
  public static final String MOBILE_AGENT_DESCRIPTION_CODE = "code";
  public static final String MOBILE_AGENT_DESCRIPTION_DATA = "data";
  ...
  public static final String MOBILE_AGENT_PROFILE_PROTOCOL = "protocol";
  ...
  public static final String MOBILE_AGENT_SYSTEM_MAJOR_VERSION =
    "major-version";
  public static final String MOBILE_AGENT_SYSTEM_MINOR_VERSION =
    "minor-version";
  ...
  public static final String MOBILE_AGENT_LANGUAGE_MAJOR_VERSION =
    "major-version";
  public static final String MOBILE_AGENT_LANGUAGE_MINOR_VERSION =
    "minor-version";
  public static final String MOBILE_AGENT_LANGUAGE_FORMAT =
	    "format";
  public static final String MOBILE_AGENT_LANGUAGE_FILTER =
	    "filter";
  public static final String MOBILE_AGENT_LANGUAGE_DEPENDENCIES =
    "dependencies";

  public static final String MOBILE_AGENT_PROTOCOL = "mobile-agent-protocol";
  public static final String MOBILE_AGENT_PROTOCOL_NAME = "name";
  public static final String MOBILE_AGENT_PROTOCOL_MAJOR_VERSION =
    "major-version";
  public static final String MOBILE_AGENT_PROTOCOL_MINOR_VERSION =
    "minor-version";
  public static final String MOBILE_AGENT_PROTOCOL_DEPENDENCIES =
    "dependencies";
  ...
  public static final String MOVE_MOBILE_AGENT_DESCRIPTION =
    "mobile-agent-description";
    
  public static final String POWERUP = "power-up";
  public static final String POWERUP_AID = "power-up-aid";

  public static final String CLONE = "clone-agent";
  public static final String CLONE_MOBILE_AGENT_DESCRIPTION =
    "mobile-agent-description";
