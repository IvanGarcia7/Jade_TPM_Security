 ...
 * 
 */
public class PowerupAction implements AgentAction {
  private AID _agentToPowerUp;

  public void setPowerUpAid(AID name) {
    _agentToPowerUp = name;
  }

  public AID getPowerUpAid() {
    return _agentToPowerUp;
  }
