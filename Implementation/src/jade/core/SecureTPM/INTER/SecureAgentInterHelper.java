...
public interface SecureAgentInterHelper extends ServiceHelper {
    ...
    */
    ...
    public static final String NAME = "jade.core.secureMobility.SecureInterAgentMobility";
    ...
    */
    ...
    public static final String REQUEST_DATA = "REMOTE_ATT_DATA";
    public static final String REQUEST_RESPONSE = "REMOTE_ATT_RESPONSE";
    public static final String REQUEST_INFORM = "REMOTE_ATT_INFORM";
