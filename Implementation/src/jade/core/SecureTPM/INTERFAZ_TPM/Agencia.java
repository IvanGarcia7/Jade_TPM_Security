...
public class Agencia{
    ...
    public static List<AID> agentes_pendientes_clonacion = new ArrayList<AID>();
    public static List<AID> agentes_pendientes_moverse   = new ArrayList<AID>();
    ...
    */
    ...
    public static File seal(File agente){
        return agente;
    }

    public static File unseal(File agente){
        return agente;
    }
