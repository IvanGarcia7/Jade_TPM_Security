...
public class SecureAgentIntraService extends BaseService {
        ...
        */
        ...
        public synchronized void doSecureMove(SecureAgent agente, Location destino) {
            ...
            */
            ...
            if (Agencia.getStatusBloqueado()==false) {
                ...
                Agencia.setStatus(true); //BLOQUEO A LA AGENCIA PARA NO PERMITIR QUE MULTIPLES AGENTES REALIZEN EL PRCESO DE MIGRACION DE FORMA CONCURRENTE
    ...
    private class CommandTargetSink implements Sink {
        ...
        private void ManejadorPeticionRespuesta(VerticalCommand comando) throws NotFoundException {
            ...
            Agent a = contenedor_actual.acquireLocalAgent(paquete_confirmacion.getNameAgent());
            ...
            contenedor_actual.releaseLocalAgent(paquete_confirmacion.getNameAgent());
